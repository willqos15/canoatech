...
export default function Contact() {
    return (
        <section id="contato" aria-label="Informações de contato"
            ...
            <IcoLogo className={'text-[#367DED] sm:w-80 sm:h-80 w-40 h-40 '} aria-hidden="true"/>
            ...
            <div className="sm:w-140 w-full">
                ...
                <ul className="flex sm:flex-row flex-col w-fit justify-center items-start gap-x-10 mx-auto gap-y-2">
                    ...
                    <li className="hover:text-[#367DED] transition duration-300 flex  items-start justify-start text-nowrap">
                        <a href="https://wa.me/5593991878598" target="_blank"  rel="noopener noreferrer">
                            <IoLogoWhatsapp className="text-4xl inline mr-1" aria-hidden="true" />
                            (93) 99187-8598
                        </a>
                    </li>

                    <li className="hover:text-[#367DED] transition duration-300  text-nowrap">
                        <a href="mailto:willqos15@gmail.com" target="_blank"  rel="noopener noreferrer">
                            <MdEmail className="text-4xl inline hover:text-[#367DED] mr-1" aria-hidden="true"/>
                            willqos15@gmail.com
                        </a>
                    </li>
                </ul>
